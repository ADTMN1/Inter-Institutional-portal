...
export default function IncomingRequestsPage() {
  ...
  const handleApprove = async (requestId: number) => {
    try {
      const response = await fetch(
        `${process.env.NEXT_PUBLIC_API_URL}/api/requests/${requestId}/approve`,
        {
          method: "POST",
        }
      );
  ...
  const handleReject = async (requestId: number) => {
    try {
      const response = await fetch(
        `${process.env.NEXT_PUBLIC_API_URL}/api/requests/${requestId}/reject`,
        {
          method: "POST",
        }
      );
  ...
  const handleSubmitSendInfo = async () => {
    ...
    try {
      const res = await fetch(
        `${process.env.NEXT_PUBLIC_API_URL}/api/requests/${selectedRequest.id}/send-info`,
        {
          method: "POST",
  ...
  const sendMoreInfoRequest = async () => {
    ...
    try {
      const response = await fetch(
        `${process.env.NEXT_PUBLIC_API_URL}/api/requests/${moreInfoRequestId}/request-more-info`,
        {
          method: "POST",
          headers: { "Content-Type": "application/json" },
