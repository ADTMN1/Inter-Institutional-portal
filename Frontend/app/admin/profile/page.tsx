...
export default function ProfilePage() {
  ...
  return (
    <div className="min-h-screen w-full flex items-center justify-center bg-blue-100 relative overflow-hidden">
      ...
      <div
        className="relative z-10 w-full max-w-2xl p-6 sm:p-10 rounded-2xl shadow-xl bg-gradient-to-r from-white via-blue-50 to-blue-100 border border-blue-400"
        style={{ minHeight: 500 }}
      >
        <div className="flex flex-row items-start gap-8">
          <div className="flex flex-col items-center gap-4 min-w-[160px]">
            ...
            >
              ...
              {isEditing && (
                <span className="absolute bottom-2 left-1/2 -translate-x-1/2 bg-white bg-opacity-80 text-xs px-2 py-1 rounded shadow group-hover:bg-blue-200 transition">
                  Change Photo
                </span>
              )}
              <input
          ...
          <form
            className="flex-1 grid grid-cols-1 sm:grid-cols-2 gap-x-8 gap-y-6"
            onSubmit={(e) => {
              e.preventDefault();
              handleSave();
            }}
          >
            ...
            <label className="font-bold sm:col-span-1">
              Email Address
              <input
                type="email"
                className="block w-full bg-blue-100 rounded-md px-4 py-2 mt-1 shadow font-normal"
